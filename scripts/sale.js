// // fetch("https://techtrove-tsly.onrender.com/api//all-products")
// //   .then((res) => res.json())
...
//     // // Create HTML content for the selected items
//     // const htmlContent = saleItems.map(
//     //   (item) => `
...
//     // // Display the HTML content inside the #temp div
